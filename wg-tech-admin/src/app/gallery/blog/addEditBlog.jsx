...
import { X, Upload, Plus, Edit, Delete } from "lucide-react";
...
const AddEditBlogDialog = ({
  ...
  reader.onload = (e) => {
    console.log("FileReader result (base64 preview):", e.target.result);
  ...
  try {
    ...
    const imageUrl = await uploadImage(file); // Your API call
            ...
            <DialogActions sx={{ p: 4, pt: 0 }}>
              ...
              >
                ...
                >
                  <CustomButton
                    variant="gradientbtn"
                    btnLabel={isEdit ? "Update Blog" : "Add Blog"}
...
export default AddEditBlogDialog;
